...
from keras.layers import Dense, Dropout, Activation, Flatten, Conv2D, MaxPooling2D, BatchNormalization, Lambda, Input, Concatenate, LSTM, LeakyReLU, Reshape
...
left_model.save(path_asmc + 'models/' +'NCPLSTMNet_ledge.h5')
...
right_model.save(path_asmc + 'models/' +'NCPLSTMNet_redge.h5')
