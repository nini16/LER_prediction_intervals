...
# of our NormCP models (NCPMaxPoolNet and NCPBLSTMNet) and try to massage this to Quantile estimates using
# a neural net.
...
X_train_path = path_asmc + "dataset/" + "X_train_QR_train5.npy"
...
left_model.save(path_asmc + 'models/' + f'QRMaxpool_BLSTMNet_ledge_{coverage_rate_string}.h5')
...
right_model.save(path_asmc + 'models/' + f'QRMaxpool_BLSTMNet_redge_{coverage_rate_string}.h5')
