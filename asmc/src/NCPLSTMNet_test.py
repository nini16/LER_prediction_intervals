...
model_left = load_model(path_asmc + 'models/' + 'NCPLSTMNet_ledge.h5', compile=False)
model_left.compile('adam', loss='mae')
model_right = load_model(path_asmc + 'models/' + 'NCPLSTMNet_redge.h5', compile=False)
...
df_test.to_pickle(path_asmc + 'models/' + "Test_df_NORMCP_approach1")

print("Calibration count: ", cal_count)

print(df.describe())

df.to_pickle(path_asmc + 'models/' + "Calibration_df_NORMCP_approach1")
...
df_norm2 = pd.read_pickle(path_asmc + 'models/' + "Calibration_df_NORMCP_approach1")
df_test_norm2 = pd.read_pickle(path_asmc + 'models/' + "Test_df_NORMCP_approach1")
